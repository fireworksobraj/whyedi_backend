...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts with full SEO control';
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Book-a-call form submissions from the website';
...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Company profiles for the homepage';
    displayName: 'Company';
  ...
  attributes: {
    ...
    licenseText: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::company.company'
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    nmlsNumber: Schema.Attribute.String;
...
export interface ApiCtaCta extends Struct.CollectionTypeSchema {
  collectionName: 'ctas';
  info: {
    description: 'Call to action buttons for the frontend';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    glow: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    target: Schema.Attribute.String & Schema.Attribute.DefaultTo<'_blank'>;
    type: Schema.Attribute.Enumeration<['link', 'modal']> &
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  collectionName: 'faqs';
  info: {
    description: 'Mortgage FAQ questions grouped by category';
    displayName: 'FAQ';
    pluralName: 'faqs';
    singularName: 'faq';
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide settings: contact info, social links, company details';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crmUrlOther: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    nmlsNumber: Schema.Attribute.String & Schema.Attribute.DefaultTo<'216981'>;
...
export interface ApiLoanTypeLoanType extends Struct.CollectionTypeSchema {
  collectionName: 'loan_types';
  info: {
    description: 'Mortgage product cards shown on the homepage';
    displayName: 'Loan Type';
    pluralName: 'loan-types';
    singularName: 'loan-type';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiReferralReferral extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Referral form submissions from the website';
    displayName: 'Referral Submission';
  ...
  attributes: {
    ...
    loanPurpose: Schema.Attribute.Enumeration<['purchase', 'refinance']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    referralEmail: Schema.Attribute.String & Schema.Attribute.Required;
    referralFirstName: Schema.Attribute.String & Schema.Attribute.Required;
    referralLastName: Schema.Attribute.String & Schema.Attribute.Required;
    referralPhone: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStateLicenseStateLicense
  extends Struct.CollectionTypeSchema {
  collectionName: 'state_licenses';
  info: {
    description: 'States where Edi Shek is licensed to originate mortgages';
    displayName: 'State License';
    pluralName: 'state-licenses';
    singularName: 'state-license';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::state-license.state-license'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    svgFile: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
